 ...
 * Name: Thomas Hoy
 * 
 * Description: Plays Ukulele strings when the user presses certain keys on the
 ...
 * Concert A frequency as 440. Based on that, you will create "Ukulele 37"
...
public class PlayInstrument {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            double sample = Ukulele.superposition();
